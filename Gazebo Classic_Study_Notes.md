...
```xml
<collision name="...">
  <geometry> ... </geometry>      <!-- 충돌체 형상 -->
  <surface>                       <!-- 충돌 표면 물리적 속성 -->
    <friction>                    <!-- 마찰 속성 설정 -->
      <ode>
...
<joint name="..." type="revolute">
  ...
  <axis>
    <xyz>x y z</xyz>                 <!-- 회전·이동 축 방향 단위벡터 -->
    <limit>
      <lower>최솟값</lower>           <!-- 최솟값 [revolute: rad / prismatic: m] -->
      <upper>최댓값</upper>
      <effort>최대 힘·토크</effort>    <!-- 최대 힘·토크 [N 또는 N·m] -->
      <velocity>최대 속도</velocity>   <!-- 최대 속도 [m/s 또는 rad/s] -->
    </limit>
  </axis>
</joint>
```
  ...
  <sensor name="front_camera" type="camera">
    ...
    <camera>
      ...
      <image>
        <width>640</width>
        <height>480</height>
        <format>R8G8B8</format>                <!-- 이미지 포맷: RGB 8비트 -->
      </image>
      <clip>
